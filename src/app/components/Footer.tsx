    ...
    <footer className="bg-[#F4F4F4] mt-[10vh]">
      <div className="max-w-7xl px-6 sm:mx-auto mx-[6%] py-16 flex flex-col gap-12 lg:flex-row lg:justify-between">
        <div className="order-1 lg:order-3 w-full lg:max-w-xs">
          ...
          <p className="sm:small-body mb-4">
          ...
          <form className="flex">
            <input
              ...
              className="flex-1 px-4 py-2 text-xs small-body rounded-sm bg-[#FDFDFD]"
            />
            <button
              type="submit"
              className="px-5 py-2 text-xs small-body text-white bg-black rounded-sm h-9 ml-2"
            >
              Subscribe
            </button>
          </form>

          <p className="mt-4 text-xs small-body leading-[140%] text-gray-500">
        ...
        <div className="order-2 lg:order-1 sm:mt-0 mt-8">
          <h1 className="sm:text-[40px] text-[32px] title sm:leading-[90%] leading-[100%]">
            Sofa
            <br />
            Society
            <br />
          ...
          <p className="mt-4 text-xs small-body">© 2024, Sofa Society</p>
        </div>

        <div className="order-3 lg:order-2 sm:mt-2 mt-0">
          <div className="grid grid-cols-3 gap-x-12 sm:text-base text-xs small-body sm:body">
