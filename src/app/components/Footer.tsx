      ...
      <div className="max-w-7xl px-6  sm:mx-auto mx-[6%] py-16 flex flex-col gap-12 lg:flex-row lg:justify-between">
        <div className="order-1 lg:order-3 w-full lg:max-w-xs">
          ...
          <form className="flex">
            ...
            <button
              type="submit"
              className="px-5 py-2 text-sm font-medium text-white bg-black rounded-sm h-9 ml-2"
            >
              Subscribe
            </button>
          </form>

          <p className="mt-4 text-xs leading-[140%] text-gray-500">
        ...
        <div className="order-2 lg:order-1 sm:mt-0 mt-8">
          <h1 className="sm:text-[40px] text-[32px] font-semibold leading-none">
            Sofa
            <br />
            Society
            <br />
        ...
        <div className="order-3 lg:order-2 sm:mt-2 mt-0">
          <div className="grid grid-cols-3 gap-x-12 text-sm font-normal">
